    ...
    if (counter >= 1) {
      ...
      starEls.push(
        <span key={i} id="fa-stack">
          <i id="star-left-half" className="fa fa-star-half title is-6" style={{color: '#ed6c63'}}></i>
          <i id="star-right-half" className="fa fa-star-o title is-6"  style={{color: '#ed6c63'}} />
        </span>
      )
      counter -= 0.5;
    }
